...
urlpatterns = [
    ...
    path(
        "admin/blacklisted-tokens/cleanup/",
        BlacklistedTokenCleanupView.as_view(),
        name="admin_blacklisted_token_cleanup",
    ),
    path("admin/refresh-tokens/", RefreshTokenListView.as_view(), name="admin_refresh_token_list"),
    path(
        "admin/refresh-tokens/<str:token_id>/revoke/",
        RefreshTokenRevokeView.as_view(),
        name="admin_refresh_token_revoke",
    ),
    # Admin - GDPR
    path("admin/deletion-requests/", DeletionRequestListView.as_view(), name="admin_deletion_request_list"),
    path(
        "admin/deletion-requests/process-expired/",
        ProcessExpiredDeletionsView.as_view(),
        name="admin_process_expired_deletions",
    ),
    path(
        "admin/deletion-requests/<str:request_id>/",
        DeletionRequestDetailView.as_view(),
        name="admin_deletion_request_detail",
    ),
    path(
        "admin/deletion-requests/<str:request_id>/process/",
        ProcessDeletionView.as_view(),
        name="admin_process_deletion",
    ),
    ...
    path(
        ...
        name="webauthn_credential_delete",
    ),
    # Dashboard
    ...
    path(
        "ai/pending-actions/<str:token>/confirm/",
        AgentPendingActionConfirmView.as_view(),
        name="agent_pending_action_confirm",
    ),
    path(
        "ai/pending-actions/<str:token>/deny/", AgentPendingActionDenyView.as_view(), name="agent_pending_action_deny"
    ),
