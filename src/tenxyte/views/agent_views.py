    ...
    @extend_schema(
        ...
        request=inline_serializer(
            ...
            fields={
                ...
                'organization': serializers.CharField(required=False, help_text='Slug organisation (alternatif à X-Org-Slug header)'),
...
class AgentTokenRevokeAllView(APIView):
    ...
    @extend_schema(
        ...
        description=(
            "Révoque immédiatement TOUS les AgentTokens actifs de l'utilisateur. "
            "Action de coupe-circuit d'urgence."
        ),
        responses={
...
class AgentPendingActionConfirmView(APIView):
    ...
    @extend_schema(
        ...
        request=inline_serializer(
            'AgentConfirmRequest',
            fields={'token': serializers.CharField(help_text='Confirmation token de l\'action')}
        ),
        responses={
            200: inline_serializer('AgentSuccessResponse', fields={'status': serializers.CharField()}),
            400: inline_serializer('AgentErrorResponse', fields={**_ErrorOut}),
    ...
    @extend_schema(
        ...
        parameters=[
            ...
            OpenApiParameter(
                ...
                description='AgentBearer <raw_token>', required=True
            ),
        ],
        request=inline_serializer(
        ...
        responses={
            ...
            403: inline_serializer(
                ...
                fields={'error': serializers.CharField(), 'status': serializers.CharField()}
            ),
        },
        examples=[
            OpenApiExample(
