...
class AgentToken(models.Model):
    ...
    triggered_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="agent_tokens")
    application = models.ForeignKey("tenxyte.Application", on_delete=models.CASCADE, related_name="agent_tokens")
    organization = models.ForeignKey(
        "tenxyte.Organization", on_delete=models.SET_NULL, null=True, blank=True, related_name="agent_tokens"
    )
    granted_permissions = models.ManyToManyField("tenxyte.Permission", related_name="agent_tokens", blank=True)
    ...
    revoked_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name="revoked_agent_tokens"
    )
