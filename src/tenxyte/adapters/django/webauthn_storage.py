...
class DjangoWebAuthnStorage:
    ...
    def get_credentials_for_user(self, user_id: str) -> List[dict]:
        ...
        try:
            ...
            creds = WebAuthnCredentialModel.objects.filter(user_id=user_id)
            return [
                {
                    "id": str(c.id),
    ...
    def create(self, *args, **kwargs):
        ...
        """
        from tenxyte.core.webauthn_service import WebAuthnCredential
    ...
    def _create_credential(self, credential: WebAuthnCredential) -> WebAuthnCredential:
        ...
        try:
            ...
            django_cred = WebAuthnCredentialModel.objects.create(
                ...
                public_key=(
                    credential.public_key.encode() if isinstance(credential.public_key, str) else credential.public_key
                ),
