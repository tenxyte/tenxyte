...
class BanUserSerializer(serializers.Serializer):
    ...
    reason = serializers.CharField(
        max_length=500, required=False, default="", help_text="Reason for the ban (stored in audit log)"
    )
...
class LockUserSerializer(serializers.Serializer):
    ...
    reason = serializers.CharField(
        max_length=500, required=False, default="", help_text="Reason for the lock (stored in audit log)"
    )
