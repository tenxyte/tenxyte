...
> **Date :** Juillet 2026 · **Version auditée :** 0.9.6.4.2 · **Licence :** MIT
...
|---|---|---|
| Version | 0.9.6.4.2 (Beta, pré-1.0) | Cadence de release soutenue (14+ tags) |
...
*Audit réalisé sur la base du code source (v0.9.6.4.2, branche `develop`), de la suite de tests
